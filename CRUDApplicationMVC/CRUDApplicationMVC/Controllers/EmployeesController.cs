...
namespace CRUDApplicationMVC.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        // GET: Employees
        public ActionResult Index(string Search, string Find)
        {
            if (Search == "FirstName")
            {
                var data = db.Employees.Where(model => model.FirstName.StartsWith(Find)).ToList();
                return View(data);
            }
            else if (Search == "Gender")
            {
                var data = db.Employees.Where(model => model.Gender.StartsWith(Find)).ToList();
                return View(data);
            }
            else
            {
